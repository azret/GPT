namespace Microsoft.Win32 {
    ...
    public class WinUIController<TViewModel> : IWinUIController {
        public virtual int WindowLeft { get; set; } = -1;
        public virtual int WindowTop { get; set; } = -1;
        public virtual int WindowWidth { get; set; } = -1;
        public virtual int WindowHeight { get; set; } = -1;
